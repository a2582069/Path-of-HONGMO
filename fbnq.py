...
frm1 = Frame(mwindow,bg = 'yellow',height = 300)#黄色区域
frm2 = Frame(mwindow,bg = 'green',height = 300)#绿色区域
frm3 = Frame(mwindow,bg = 'blue',height = 200)#按钮区域
frm4 = Frame(mwindow,height = 300)#备注区域
frm5 = Frame(mwindow,bg = 'thistle',height = 300)#价格区域
frm6 = Frame(mwindow,bg = 'lightsteelblue',height = 300)#通货换算区域
def cmd1():
    enty1.delete(0,100)
    enty1.insert(0,get_price(html_list[0],listnum=listnum))
    enty2.delete(0,100)
    enty2.insert(0,get_price(html_list[1],listnum=listnum))
    enty3.delete(0,100)
    enty3.insert(0,get_price(html_list[2],listnum=listnum))
    enty4.delete(0,100)
    enty4.insert(0,get_price(html_list[3],listnum=listnum))
    enty5.delete(0,100)
    enty5.insert(0,get_price(html_list[4],listnum=listnum))
    enty6.delete(0,100)
    enty6.insert(0,get_price(html_list[5],listnum=listnum))
    enty7.delete(0,100)
    enty7.insert(0,get_price(html_list[6],listnum=listnum))
    enty8.delete(0,100)
    enty8.insert(0,get_price(html_list[7],listnum=listnum))
    enty9.delete(0,100)
    enty9.insert(0,get_price(html_list[8],listnum=listnum))
    enty10.delete(0,100)
    enty10.insert(0,get_price(html_list[9],listnum=listnum))
    enty11.delete(0,100)
    enty11.insert(0,get_price(html_list[10],listnum=listnum))
    enty12.delete(0,100)
    enty12.insert(0,get_price(html_list[11],listnum=listnum))
    enty13.delete(0,100)
    enty13.insert(0,get_price(html_list[12],listnum=listnum))
    enty14.delete(0,100)
    enty14.insert(0,get_price(html_list[13],listnum=listnum))
    enty15.delete(0,100)
    enty15.insert(0,get_price(html_list[14],listnum=listnum))
    enty16.delete(0,100)
    enty16.insert(0,get_price(html_list[15],listnum=listnum))
    enty17.delete(0,100)
    enty17.insert(0,get_price(html_list[16],listnum=listnum))
    enty18.delete(0,100)
    enty18.insert(0,get_price(html_list[17],listnum=listnum))
    enty19.delete(0,100)
    enty19.insert(0,get_price(html_list[18],listnum=listnum))
    enty20.delete(0,100)
    enty20.insert(0,get_price(html_list[19],listnum=listnum))
    enty21.delete(0,100)
    enty21.insert(0,get_price(html_list[20],listnum=listnum))
    enty22.delete(0,100)
    enty22.insert(0,get_price(html_list[21],listnum=listnum))
    enty23.delete(0,100)
    enty23.insert(0,get_price(html_list[22],listnum=listnum))
    enty24.delete(0,100)
    enty24.insert(0,get_price(html_list[23],listnum=listnum))
    enty25.delete(0,100)
    enty25.insert(0,get_price(html_list[24],listnum=listnum))
...
entex = Entry(frm3,width = 10)
button1 = Button(frm3,text = 'Reload',command = cmd1,height = 1)
button2 = Button(frm3,text = 'Run it',command = cmd2,height = 1)
button3 = Button(frm3,text = 'Readit',command = cmd2,height = 1)
button4 = Button(frm3,text = 'Saveit',command = cmd2,height = 1)
...
frm6.place(x = 300,width = 300,height = 1100)
